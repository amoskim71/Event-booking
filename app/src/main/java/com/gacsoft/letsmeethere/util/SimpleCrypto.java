 ...
 *
 *******************************************************************************/
package com.gacsoft.letsmeethere.util;
...
public class SimpleCrypto {
    ...
    public static String decrypt(String seed, String encrypted) throws Exception {
        try {
            ...
            try {
                // on exception try whether it is an old key or not
                return decryptCompatible(seed, encrypted);
            }
            catch (Exception e2) {
                // it is not an old key, so propagate the original exception
                throw e;
            }
        }
    }
    ...
    public static String decryptCompatible(String seed, String encrypted) throws Exception {
        byte[] rawKey = getCompatibleRawKey(seed.getBytes());
        byte[] enc = toByte(encrypted);
        byte[] result = decrypt(rawKey, enc);
        return new String(result);
    }
